...
const mean_of_features =[5.44628099e+01, 6.57024793e-01, 9.91735537e-01, 1.30359504e+02,
      2.46842975e+02, 1.28099174e-01, 5.53719008e-01, 1.50115702e+02,
      3.14049587e-01, 1.01322314e+00, 1.42148760e+00, 6.81818182e-01,
      2.30165289e+00];
       
const variance = [8.43725838e+01, 2.25343214e-01, 1.04125401e+00, 2.82040178e+02,
      2.77584311e+03, 1.11689775e-01, 2.80172119e-01, 4.97565125e+02,
      2.15422444e-01, 1.21065159e+00, 3.67802746e-01, 9.77272727e-01,
      3.51154293e-01] ;
       
       
const weights = [-0.09005275, -0.7291416 ,  0.6598856 , -0.25411126, -0.1614455 ,
         0.1166103 ,  0.24034064,  0.46880907, -0.49103144, -0.7343311 ,
         0.30284047, -0.6067721 , -0.55872846]
...
exports.handler = async (event) => {
  ...
  for(let i in post_data){
    ...
    result = result + ((post_data[i] - mean_of_features[index])/Math.sqrt(variance[index]))*weights[index]; 
